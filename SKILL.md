...
> **标签**: `AI` `摄影诊断` `多智能体` `构图分析` `光影分析` `色彩评估` `风格对标` `修图建议` `Lightroom` `PDF报告` `TRAE-Skill` `Claude-Code` `人像` `风光` `纪实` `星空` `生态` `建筑` `静物`
...
- **10套场景预设**：日系清新 / 电影感 / 复古胶片 / 黑白经典 / 户外风光 / 日落金调 / 蓝调冷色 / 星空调色 / 静物质感 / 纪实
